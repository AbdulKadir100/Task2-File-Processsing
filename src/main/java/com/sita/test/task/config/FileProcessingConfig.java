...
public class FileProcessingConfig {
	...
	public IntegrationFlow fileProcessingFlow() {
	    return IntegrationFlows.from(finalChannel())
	            .transform(Transformer.fromTransformer(Files.toStringTransformer())) // Convert file content to String
	            .transform(Integer::parseInt) // Convert String to Integer
	            .aggregate(aggregator -> aggregator
	                    .outputProcessor(group -> { // Aggregate integers into sum
	                        int sum = 0;
